...
redTol          = 80;                      % the amount of red tolerance for the selector
blueTol         = 70;                       % the amount of blue tolerance for the selector
greenTol        = 70;                       % the amount of green tolerance for the selector
%   Main loop
for i = start:step:stop                     % read images in the consequtive order
    ...
    while(1)
        ...
        elseif val == 29
            ...
            count = count -1;
        elseif val == 119 %strcmpi(ip,'normal')
            if length(NL) ~= 0
                hold on;
                count = count+1;
                if NL(1) <= 1
